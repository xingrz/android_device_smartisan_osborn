...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/audio_platform_info_skush.xml:system/etc/audio_platform_info_skush.xml \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_skus.xml:system/etc/mixer_paths_skus.xml \
    $(LOCAL_PATH)/audio/mixer_paths_skush.xml:system/etc/mixer_paths_skush.xml \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_wcd9340.xml:system/etc/mixer_paths_wcd9340.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/msm_irqbalance_sdm630.conf:system/vendor/etc/msm_irqbalance_sdm630.conf
